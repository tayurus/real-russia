		...
		<div data-step="1" class="step">
			...
			<div class="input mt-5">
				<div class="input__wrapper input__wrapper_correct">
					...
					<select class="input__select">
						<option value="">Single entry visa</option>
						<option value="">Double entry visa</option>
						<option value="">Multi entry visa</option>
						<option value="">Mo-mo-mo-nster entry visa</option>
					</select>
				</div>
				<div class="input__highlight"></div>
				<div class="hint">
			...
			<div class="input mt-5">
				<div class="input__wrapper input__wrapper_correct">
					...
					<select class="input__select">
						<option value="">Meet old friends</option>
						<option value="">Working</option>
						<option value="">I'm a Syrian terrorist.</option>
					</select>
				</div>
				<div class="input__highlight"></div>
				<div class="hint">
			...
			<div class="input mt-5">
				<div class="input__wrapper input__wrapper_correct">
					...
					<br/>
					<input type="text" readonly="readonly" class="input__select total__select total__country"/>
				</div>
				<div class="input__highlight"></div>
				<div class="hint">
					<div class="hint__header">
